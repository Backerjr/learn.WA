    ...
    const resources = [
        {
            ...
            type: "Audio - Drills and exercises to perfect your pronunciation.",
        ...
        },
        {
            ...
            type: "Video - Learn when and how to use this tense.",
        ...
        },
        {
            ...
            type: "Video - Key phrases for successful negotiations.",
        ...
        },
        {
            ...
            type: "Quiz - Test your knowledge of common phrasal verbs.",
        ...
        {
            title: "Beginner Grammar: Articles",
            type: "PDF - A complete guide to using 'a', 'an', and 'the'.",
        ...
        {
            title: "Listening Comprehension: A News Report",
            type: "Audio - Listen to a report and answer questions.",
            ...
            gridSpan: 'col-span-2 lg:col-span-4'
        },
        {
            title: "Advanced Vocabulary PDF",
            type: "PDF - Expand your vocabulary with advanced words.",
        ...
        {
            title: "Writing Emails: Formal vs Informal",
            type: "Video - Understand the key differences in tone.",
                        ...
                        <div className="flex flex-1 justify-end items-center gap-4">
                            <label className="hidden md:flex flex-col min-w-40 !h-10 max-w-64">
                                <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                                    <div className="text-text-secondary-light dark:text-text-secondary-dark flex bg-card-light dark:bg-card-dark items-center justify-center pl-3 rounded-l-lg border-r-0">
                                        <span className="material-symbols-outlined">search</span>
                                    </div>
                                    <input className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-text-primary-light dark:text-text-primary-dark focus:outline-0 focus:ring-2 focus:ring-primary/50 border-none bg-card-light dark:bg-card-dark h-full placeholder:text-text-secondary-light dark:placeholder:text-text-secondary-dark px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal" placeholder="Search" />
                                </div>
                            </label>
                            <button className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 w-10 bg-card-light dark:bg-card-dark text-text-primary-light dark:text-text-primary-dark text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5">
                        ...
                        <div className="layout-content-container flex flex-col max-w-7xl mx-auto flex-1">
                            ...
                            <div className="flex flex-wrap justify-between gap-4 p-4">
                                <div className="flex min-w-72 flex-col gap-2">
                                    <p className="font-heading text-4xl font-bold tracking-tight text-text-primary-light dark:text-text-primary-dark">Resource Library</p>
                                    <p className="text-text-secondary-light dark:text-text-secondary-dark text-base font-normal leading-normal">A repository of all your supplementary learning materials.</p>
                                </div>
                            </div>
                            {/* Chips/Filters */}
                            <div className="flex gap-2 md:gap-3 p-3 flex-wrap border-b border-card-light dark:border-card-dark mb-8">
                                <button className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-card-light dark:bg-card-dark pl-4 pr-3 hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors">
                                ...
                                <button className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-card-light dark:bg-card-dark pl-4 pr-3 hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors">
                                    <span className="material-symbols-outlined text-text-secondary-light dark:text-text-secondary-dark">school</span>
                                    <p className="text-sm font-medium">Course</p>
                                    <span className="material-symbols-outlined text-text-secondary-light dark:text-text-secondary-dark">expand_more</span>
                                </button>
                                <button className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-card-light dark:bg-card-dark pl-4 pr-3 hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors">
                                    <span className="material-symbols-outlined text-text-secondary-light dark:text-text-secondary-dark">label</span>
                                    <p className="text-sm font-medium">Topic</p>
                                    <span className="material-symbols-outlined text-text-secondary-light dark:text-text-secondary-dark">expand_more</span>
                                </button>
                                <div className="flex-grow"></div>
                                <button className="flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-lg bg-primary pl-4 pr-4 text-white transition-opacity hover:opacity-90">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 p-4">
                                {resources.map((resource, index) => (
                                    <div key={index} className={`${resource.gridSpan} group flex cursor-pointer flex-col gap-4 rounded-xl bg-card-light dark:bg-card-dark p-4 transition-transform hover:-translate-y-1`}>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            {resource.featured && <span className="text-xs font-semibold text-secondary">FEATURED</span>}
                                            <p className="text-lg font-bold leading-tight font-heading">{resource.title}</p>
                                            <p className="text-text-secondary-light dark:text-text-secondary-dark text-sm font-normal">{resource.type}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
