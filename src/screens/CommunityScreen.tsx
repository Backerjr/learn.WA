            ...
            <div className="flex min-h-screen items-center justify-center">
                <div className="flex flex-col items-center gap-8 p-8">
                    ...
                    <div className="text-center">
                        <h1 className="font-heading text-5xl font-bold tracking-tight text-text-light-primary dark:text-text-dark-primary mb-4">Community Forum</h1>
                        <p className="text-xl text-text-light-secondary dark:text-text-dark-secondary max-w-md">
                            Coming Soon
                        </p>
                        <p className="mt-4 text-base text-text-light-secondary dark:text-text-dark-secondary max-w-md">
